...
| **IV. Backing services** | [docker-compose.yml](https://github.com/JoseMON-Dev/log-service/tree/master/log-service/docker-compose.yml#L13-25) | InfluxDB se trata como un servicio externo gestionado independientemente del código de la aplicación, permitiendo su reemplazo o escalado sin cambios lógicos. |
| **V. Build, release, run** | [Dockerfile](https://github.com/JoseMON-Dev/log-service/tree/master/log-service/Dockerfile) [Publish](https://github.com/JoseMON-Dev/log-service/blob/master/.github/workflows/docker-publish.yml)| El proceso de despliegue separa estrictamente la construcción de la imagen de su ejecución final en el contenedor. |
